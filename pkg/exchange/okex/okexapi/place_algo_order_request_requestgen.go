// Code generated by "requestgen -method POST -responseType .APIResponse -responseDataField Data -url /api/v5/trade/order-algo -type PlaceAlgoOrderRequest -responseDataType []PlaceAlgoOrderResponse"; DO NOT EDIT.
...
func (p *PlaceAlgoOrderRequest) Do(ctx context.Context) ([]PlaceAlgoOrderResponse, error) {
	...
	var data []PlaceAlgoOrderResponse
